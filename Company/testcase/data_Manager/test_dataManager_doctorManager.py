...
class Test_doctorManager:
    ...
    def test_doctorManager_All(self):
        ...
        result = Request.execute("config_dataManager.xlsx", "common", "doctorManager_All")
    ...
    def test_doctorManager_EDITOR(self):
        ...
        conf_filename = "dataManager.ini"
        Request = requestAPI(log, conf_filename, section)
        result = Request.execute("config_dataManager.xlsx", "common", "doctorManager_EDITOR")
    ...
    def test_doctorManager_AUDITOR(self):
        ...
        conf_filename = "dataManager.ini"
        Request = requestAPI(log, conf_filename, section)
        result = Request.execute("config_dataManager.xlsx", "common", "doctorManager_AUDITOR")
