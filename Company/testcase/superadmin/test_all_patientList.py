...
class Test_user_patientList:
    ...
    def test_user_patient_All(self):
        ...
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_All")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到所有的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_finish(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log, conf_filename, section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList")
    ...
    def test_user_patient_AUDIT_PASS(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log, conf_filename, section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_AUDIT_PASS")
    ...
    def test_user_patient_AUDITING(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log, conf_filename, section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_AUDITING")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到审核中的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_EDITING(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_EDITING")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到标注中的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_WAIT_FOR_EDIT(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_WAIT_FOR_EDIT")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到已标注的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_ANALYZE_FAILED(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_ANALYZE_FAILED")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到分析失败的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_ANALYZING(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_ANALYZING")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到分析中的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_WAIT_FOR_ANALYZE(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_WAIT_FOR_ANALYZE")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到待分析的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_UPLOAD_FAILED(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_UPLOAD_FAILED")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到上传失败的报告ID放入 superAdmin.ini中
    ...
    def test_user_patient_INITIAL(self):
        ...
        conf_filename = "superAdmin.ini"
        Request = requestAPI(log,conf_filename,section)
        result = Request.execute("config_superAdmin.xlsx", "common", "patientList_INITIAL")

        # print(result)
        log.info("返回结果为：")
        log.info(result)

        # 取到未上传的报告ID放入 superAdmin.ini中
